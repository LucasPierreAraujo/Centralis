...
import { X, Plus, Upload, ChevronLeft, ChevronRight, CheckCircle, Trash2, Eye, EyeOff } from 'lucide-react';
import { RITOS, CARGOS_PADRAO, getTerminologiaPadrao } from '../../lib/rito';

// modoApp=true muda o botão de sucesso de "Ir para o Login" para "Fechar"
export default function ModalCadastroLoja({ onClose, modoApp = false }) {
        ...
        <div className="p-6">
          ...
          {etapa === 1 && (
            <div className="space-y-4">
              ...
              <Campo label="E-mail do Venerável Mestre *">
                <input
                  type="email"
            ...
            <div className="space-y-5">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="space-y-3">
                  ...
                  <Campo label="2° Grau (Companheiro)">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="space-y-4">
                  ...
                  <Campo label="Senha de app do Gmail">
                    <PasswordInput
          ...
          {etapa === 5 && (
            <div className="text-center space-y-4 py-4">
              ...
              <p className="text-gray-600 text-sm">
                ...
                {modoApp
                  ? <>Use o usuário <strong>{form.username}</strong> para acessá-la no próximo login.</>
              ...
              >
                {modoApp ? 'Fechar' : 'Ir para o Login'}
              </button>
            </div>
          )}
